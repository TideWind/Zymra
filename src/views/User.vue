              ...
              <el-card class="card" style="width:1080px; height: 1080px">
                  ...
                  <el-row style="margin-top: 30px; margin-bottom:40px;">
                    ...
                    <div>
                      ...
                      <div style="margin-left:654px; margin-top:-110px">
                      ...
                      <el-divider style="margin-top:40px; margin-left:30px; width:740px"/>
                      ...
                      <div style="margin-top:-30px; margin-left: 40px;">
                        ...
                        <div style="display:inline-block; margin-left: 20px; text-align: center;">
                          ...
                          <p style="font-size:14px; margin-top:-18px; color: #888">获赞</p>
                        </div>
                    ...
                    <router-link :to="'/music/' + item.mid">
                      <el-row >
                        ...
                        <el-col :span="4" style="margin-top:5px; margin-left:-120px">
                          <el-image :src="item.src" style="width:50px; height: 50px;  border: 1px solid transparent; border-radius: 8px;" fit="cover"/>
                        </el-col>
                        <el-col :span="4" style="margin-top:-5px; margin-left:-100px">
